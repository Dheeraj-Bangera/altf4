...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-row items-end justify-end bg-[#B19470] h-fit text-white">
            <div className="overflow-hidden">
                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-1 px-4 gap-12 cursor-pointer ">
                    ...
                    <div>
                        ...
                        <li className="my-4 list-none hover:underline">Kitchen</li>
                        <li className="my-4 list-none hover:underline">Counter</li>
                    ...
                    <div className="mb-4 md:mb-0">
                        ...
                        <p className="text-[16px] my-4">Email: @.gmail.com</p>
                ...
                <h6 className="text-center">&copy; right Kennel {Year}</h6>
            </div>
        </footer>
    );
};
